<?php include("lib/common.php"); include("lib/session_check.php"); $menu='master'; ?><!DOCTYPE html> <?php $ptype="Payment"; 
$res=$objMain->getRow("select * from withdraw_request where id=".$id);
?>
<html lang="en">
<head>
    ...
    <?php if(isset($msg)) { ?>
      <div class="alert alert-<?php echo $atype; ?> alert-dismissable">
          ...
          <?php } ?>
                            ...
                            <div class="card-body">
                                <form method="post" action="init.php?module=admin&action=payment&do=update&id=<?php echo $id; ?>" enctype="multipart/form-data" >
